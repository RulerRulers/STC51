...
extern void lcd_TurnOnBacklight(uint8_t on);
...
/*buz.c*/
extern void buz_Initialization(void);
extern void buz_TurnOn(unsigned char on);

/*adc.c*/
extern void adc_Initialization(void);
extern uint16_t adc_GetChannelValue(uint8_t ch);
