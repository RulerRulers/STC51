...
extern void pfs_Main(uint8_t argc,char *argv[]);

#define MAX_ARG_NUM 5
extern char *strsep(char **s, const char *ct);
static void ProcessOneLine(char xdata *cmd_line) large
{
	unsigned char argc;
	...
	else if (strcmp(argv[0], "?") == 0 || 0 == strcmp(argv[0], "help"))
	{
		...
		printf("pfs: petitFatFs test command.\r\n");
